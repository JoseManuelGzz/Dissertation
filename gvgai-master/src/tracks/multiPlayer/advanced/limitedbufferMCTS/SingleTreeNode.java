package tracks.multiPlayer.advanced.limitedbufferMCTS;

import core.game.StateObservationMulti;
import ontology.Types;
import tools.ElapsedCpuTimer;
import tools.Utils;
import tracks.multiPlayer.opponentModels.LimitedBuffer;
...
public class SingleTreeNode
{
    ...
    public SingleTreeNode expand(StateObservationMulti state) {
        ...
        LimitedBuffer limBuffer = new LimitedBuffer(oppID);
        this.buffer.add(actions[id][bestAction]);
        acts[oppID] = limBuffer.getOpponentAction(this.buffer);
    ...
    public SingleTreeNode uct(StateObservationMulti state) {
        ...
        //get actions available to the opponent and assume they will do a random action
        LimitedBuffer limBuffer = new LimitedBuffer(oppID);
        this.buffer.add(actions[id][selected.childIdx]);
        acts[oppID] = limBuffer.getOpponentAction(this.buffer);
        //setAdvanceCounter(fallible.advanceCounter);
