...
import tools.Utils;
import tracks.multiPlayer.opponentModels.UnlimitedBuffer;
...
public class SingleTreeNode
{
    ...
    public SingleTreeNode expand(StateObservationMulti state) {
        ...
        UnlimitedBuffer unlimBuffer = new UnlimitedBuffer(oppID);
        this.buffer.add(actions[id][bestAction]);
        acts[oppID] = unlimBuffer.getOpponentAction(this.buffer);
