package tracks.multiPlayer.advanced.probabilisticMCTS;
...
import tools.Utils;
import tracks.multiPlayer.opponentModels.Probabilistic;
...
public class SingleTreeNode
{
    ...
    public SingleTreeNode expand(StateObservationMulti state) {
        ...
        Probabilistic probabilistic = new Probabilistic(oppID);
        acts[oppID] = probabilistic.getOpponentAction(state, this.epsilon, this.m_rnd);
